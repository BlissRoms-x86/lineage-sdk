...
public class Build {
    ...
    public static final String LINEAGEOS_VERSION = getString("ro.bliss.version");

    /** A build ID string meant for displaying to the user */
    public static final String LINEAGEOS_DISPLAY_VERSION = getString("ro.bliss.display.version");
